databaseChangeLog = {
	...
	changeSet(author: "varuzza (generated)", id: "1433772759776-1") {
	       sql("""
...
""");
	...
	changeSet(author: "varuzza (generated)", id: "1433772759776-2") {
		createIndex(indexName: "price_sku", tableName: "price") {
			column(name: "sku")
		}
	}

	changeSet(author: "varuzza (generated)", id: "1433772759776-3") {
		createIndex(indexName: "price_updated_on", tableName: "price") {
			column(name: "updated_on")
		}
	}

	changeSet(author: "varuzza", id: "1433772759776-4") {
	       sql("""
...
order by sku,updated_on  desc;""")
	...
	changeSet(author: "varuzza", id: "1433772759776-5") {
	       sql("""
...
""")
     ...
     changeSet(author: "varuzza", id: "1433772759776-6") {
