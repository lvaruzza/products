...
<head>
	<meta name='layout' content='springSecurityUI2'/>
	...
	<s2ui:tab name='userinfo' height='280'>
		...
		<tbody>
			...
			<s2ui:textFieldRow name='name' labelCode='user.name.label' bean="${user}"
                            labelCodeDefault='Full Name' value="${user?.name}"/>

			<s2ui:textFieldRow name='email' labelCode='user.email.label' bean="${user}"
                            labelCodeDefault='Email' value="${user?.email}"/>

			<s2ui:textFieldRow name='initials' labelCode='user.initials.label' bean="${user}"
                            labelCodeDefault='Initials' value="${user?.initials}"/>
