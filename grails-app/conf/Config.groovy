...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'products.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'products.UserRole'
grails.plugin.springsecurity.authority.className = 'products.Role'
